...
public class OrderItemDTO {
	...
	public String toString() {
		return "OrderPageItem [orderId = " + orderId + "bookId=" + bookId + ", bookCount=" + bookCount + ", orderItemId=" + orderItemId
				+ ", bookPrice=" + bookPrice + ", bookDiscount=" + bookDiscount + ", salePrice=" + salePrice
				+ ", totalPrice=" + totalPrice + ", savePoint=" + savePoint + ", totalSavePoint=" + totalSavePoint + ", imageList=" + "]";
	}

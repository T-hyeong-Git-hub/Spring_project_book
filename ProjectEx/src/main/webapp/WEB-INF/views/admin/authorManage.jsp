...
<body>
 ...
 <script>
 //페이지가 로드될 때 반드시 실행이 되는 익명 함수
 $(document).ready(function(){
	 let result = '<c:out value="${enroll_result}"/>';
	 let mresult = '<c:out value="${modify_result}"/>';
	 // c:out 태그
	 // 작가이름 작성을 할 때 유효성 검사를 통해 스크립트 코드를 작성하지 못하도록 
	 // 스크립트 코드가 입력되더라도 출력되는 값()에도 스크립트 코드가 실행이 되지 않도록 할 수 있는 방법 
	 ...
	 function checkResult(result){
		 ...
		 alert("작가'${enroll_result}'을 등록했습니다.");
	 }

...
<script>
	...
	$(document).ready(function(){
		...
		/* 이미지 삽입 */
		$(".image_wrap").each(function(i, obj){// i는 순회하면서 실행될 때의 index이고 obj는 그 순서의 객체
		...
		if(bobj.data("bookid")){
			...
			//클래스 속성명이 .image_wrap 인 <div> 태그 내부에 있는 <img> 태그를 호출하고, <imv> 태그에 이미지를 호출하는 url을 값으로 가지는 src 속성이 추가되도록 작성
		}else {
